...
The syntax is simple: `limit <n>`, where `n` is the maximum number of entries to allow through, or `limit <n> <m>`, which allows the Nth through the Mth entries through.
...
To look at the packets 5 through 10:
