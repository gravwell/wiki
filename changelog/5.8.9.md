...
```{note}
This release contains a high priority bug fix for a security violation where secrets were not properly masked in some error messages.
```
...
* Fixed an issue where secrets were not properly masked in some error messages.
