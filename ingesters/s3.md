...
If you have large amounts of S3 data and/or are interested in "tailing" S3 data, you probably should be using [SQS ingester](/ingesters/sqs) or another mechanism like (Amazon Kinesis)[/ingesters/kinesis].
