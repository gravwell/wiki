...
The Cisco ISE preprocessor is named `cisco_ise` and supports the ability to reassemble multipart messages, reformat the messages into a more usable format, filter unwanted message pairs, and remove redundant message headers.
