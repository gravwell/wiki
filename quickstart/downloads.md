...
[Download Gravwell Core Installer](https://update.gravwell.io/files/gravwell_3.0.1.sh) (MD5: accbb434c17d59265c0dffcaeb842468)
...
| [File Follower](#!ingesters/ingesters.md#File_Follower) | The standard file following ingester designed to look for line broken log entries in files.  Useful for ingesting logs from systems that can only log to files. |018616102a1cc97895e9cad7e3c41243| [Download](https://update.gravwell.io/files/gravwell_file_follow_installer_3.0.1.sh) |
| [HTTP POST Ingester](#!ingesters/ingesters.md#HTTP_POST) | The HTTP POST ingester allows for hosting a simple webserver that takes HTTP POST requests in as events.  SOHO and IOT devices often support webhook functionality which the HTTP POST ingester is perfectly suited to suport. |0137d3e832fd635b9cefcc6e3a51e536| [Download](https://update.gravwell.io/files/gravwell_http_ingester_installer_3.0.1.sh) |
| [Netflow Capture](#!ingesters/ingesters.md#Netflow_Ingester) | The Netflow Capture ingester acts as a Netflow v5 collector, ingesting Netflow records as Gravwell entries. |e0addf09282313caf2cc95d1838bdc5d| [Download](http://update.gravwell.io/files/gravwell_netflow_capture_installer_3.0.1.sh) |
