...
For non-Debian systems, download the [self-contained installer](https://update.gravwell.io/files/gravwell_community_2.1.1.tar.bz2) and extract it:

```
curl -O https://update.gravwell.io/files/gravwell_community_2.1.1.tar.bz2
md5sum gravwell_community_2.1.1.tar.bz2 #should be 44e6e9c5699807013593260e2d4ea879
tar xjvf gravwell_community_2.1.1.tar.bz2
```

Then run the installer:

```
sudo bash gravwell_community_2.1.1.sh
```
